...
def donuts(count):
    ...
    if count >= 10:
        ...
        donut_result = count
    return donut_txt.format(donut_result)
...
def fix_start(s):
    ...
    char = s[0]
    rest = s[1:]
    rest_modified = rest.replace(char, "*")
    fix_start_result = char+rest_modified
...
def mix_up(a, b):
    ...
    b_rest = b[2:]
    # your code here
    return b_start + a_rest + " " + a_start+b_rest
